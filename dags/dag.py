    ...
    catchup=False,
        ...
        with TaskGroup(group_id = "download2") as group4:
            download4 = PythonOperator(
                                        ...
                                        python_callable=dagUtils.get_data,
                                        op_kwargs={'bucket_name':"ad-recommender-system", 
                                                'file_path':"/airflow_subprocess_data/advertiser.csv"})
